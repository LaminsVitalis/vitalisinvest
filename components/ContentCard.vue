<template>
  <div :class="[colorScheme.cardBg, 'backdrop-blur-md rounded-lg p-4 hover:bg-white/20 transition-all duration-300 cursor-pointer']" @click="$emit('acessar-conteudo', item.id)">
